...
def extract():
    ...
    # The base genres
    genres_inst = Genres()
    genres = genres_inst.get_genres()
    genre13_dict = genres_inst.get_empty_genre13()
    genre10_dict = genres_inst.get_empty_genre10()
    genre8_dict = genres_inst.get_empty_genre8()
